...
@server.route('/delete/Pb/<int:id>/<string:img>',methods=['GET','POST'])
...
@server.route('/delete/Pp/<int:id><string:img>',methods=['GET','POST'])
...
@server.route('/delete/Pt/<int:id>/<string:img>',methods=['GET','POST'])
